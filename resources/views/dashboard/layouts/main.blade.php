...
{{--                        {{ route('logout') }}--}}
                ...
                <li class="nav-item dropdown">
                  ...
                  <img class="user-avatar rounded-circle20 mr-2" src="" alt="Admin Avatar">
{{--                      {!! asset(Auth::user()->avatar) !!}--}}
                  <span class="d-none d-md-inline-block mr-2">    </span>
{{--                      {{ Auth::user()->name }}--}}
                </a>
                 <!-- ============================================= nav admin Site ============================================= -->
                <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item" href="">
{{--                        {{ url('dashboard/dashboardUsers') }}/{{ Auth::user()->name }}/edit--}}
                      <i class="icon-feather-edit"></i> Edit Profile</a>
                      <a class="dropdown-item" href="">
{{--                          {{ url('dashboard/dashboardSettings') }}--}}
